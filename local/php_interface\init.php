...
class MyClass
{
    // СЃРѕР·РґР°РµРј РѕР±СЂР°Р±РѕС‚С‡РёРє СЃРѕР±С‹С‚РёСЏ "OnBeforeIBlockElementAdd"
    function OnBeforeIBlockElementAddHandler(&$arFields)
    { // РўСЂР°РЅСЃР»РёС‚РµСЂРёСЂСѓРµРј CODE СЌР»РµРјРµРЅС‚РѕРІ
    $name = $arFields["NAME"];
    ...
    // Р•СЃР»Рё iblock - FAQ, РґРѕР±Р°РІР»СЏРµРј РЅР°Р·РІР°РЅРёРµ С‚РµРєСЃС‚ Р°РЅРѕРЅСЃР°
...
// Р¤СѓРЅРєС†РёСЏ РґР»СЏ СЃРѕСЂС‚РёСЂРѕРІРєРё РјР°СЃСЃРёРІР°
function cmp($a, $b){

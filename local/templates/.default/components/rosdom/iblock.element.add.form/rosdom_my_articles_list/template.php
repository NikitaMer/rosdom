...
<form name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data">
	...
	<table class="data-table">
		...
		<tfoot>
			<tr>
				<td colspan=2>
<span class="starrequired">*</span> Поля, помеченные звездочкой, обязательны для заполнения. <br /><br />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td >
					<input id="iblock_add" style="border:0; bachground:white; text-decoration:underline; color:#0479bd; cursor:pointer; " type="submit" name="iblock_submit" value="Продолжить" />
				</td>
			</tr>
		</tfoot>
	</table>

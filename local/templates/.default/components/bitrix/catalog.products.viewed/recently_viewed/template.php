	...
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		foreach ($arResult['ITEMS'] as $item)
		{
            ...
            $productTitle = (
                    ...
                    : GetMessage("HOUSE_PROJECT").$item['NAME']
                );
            ?>            
            <div class="bx_catalog_item" id="<? echo $strMainID; ?>" > 
                <div class="bx_catalog_item_container" > 
                    <a href="<? echo $item['DETAIL_PAGE_URL']; ?>"><img src="<? echo $item['PREVIEW_PICTURE']['SRC']; ?>" alt="<? echo strip_tags(html_entity_decode($productTitle)) ?>" title="<? echo strip_tags(html_entity_decode($productTitle)) ?>" class="bx_catalog_item_img"></a>
                    <div class="bx_catalog_item_title"><a href="<? echo $item['DETAIL_PAGE_URL']; ?>" title="<? echo strip_tags(html_entity_decode($productTitle)) ?>"><?echo html_entity_decode($productTitle);?></a></div>
                    <br/>
                </div>
            </div><?
            $j++;

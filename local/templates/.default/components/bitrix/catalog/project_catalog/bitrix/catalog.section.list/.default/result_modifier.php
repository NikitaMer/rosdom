...
foreach($arResult["SECTIONS"] as $key=>$arItem){
    $dbres = CIBlockSection::GetList(array(),array('IBLOCK_ID'=>$arItem["IBLOCK_ID"],'ID'=>$arItem["ID"]),false,array('UF_*'))->Fetch();
    $arResult["SECTIONS"][$key]["UF_SHOW_MENU"] = $dbres["UF_SHOW_MENU"];
    $arResult["SECTIONS"][$key]["UF_SORT_MENU"] = $dbres["UF_SORT_MENU"];      
}
?>
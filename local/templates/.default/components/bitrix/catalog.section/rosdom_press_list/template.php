...
<?
//echo $arElement["PROPERTIES"]["company"]["ID"];

$db = CIBlockElement::GetByID($arElement["PROPERTIES"]["company"]["VALUE"]);
if($res = $db->GetNext()) {
...
<?//  echo "<pre>"; print_r($arElement["PROPERTIES"]["company"]); echo "<pre>";?>


<div class="b-subsection">
	<table> 
	<tr><td>
<a href="<?=$arElement["DETAIL_PAGE_URL"]?>"><img src="<?=CFile::GetPath($res["PREVIEW_PICTURE"])?>" /></a>
	</td><td>
		<?=$arElement[ACTIVE_FROM]?>
	   	<h2><a href="<?=$arElement["DETAIL_PAGE_URL"]?>"><?=$arElement["NAME"]?></a></h2>
<!--		 <p class="more"><a href="/">Перейти к разделу</a></p> -->
	</td></tr>
	</table> 
</div>
<?endforeach;?>
...
<div style="_clear:both; overflow:hidden;"> </div>

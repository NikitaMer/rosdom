...
<?if (empty($_REQUEST['MAIN_SECTION_CODE'])) { ?>
...
<? foreach ( $arResult["ITEMS"] as $arItem): ?>
	...
	<?=$arItem['PROPERTIES']['MENUTITLE']['VALUE']?>
	</a>
	</h2>
	<figure>
	
	<figcaption>
	<p><b>Телефон</b>: <?=$arItem['PROPERTIES']['TELEPHONE']['VALUE']?></p>
	<p><b>Расстояние от МКАД</b>: <?=$arItem['PROPERTIES']['MKAD']['VALUE']?> км.</p>
		</figcaption>
	</figure>
	</div>

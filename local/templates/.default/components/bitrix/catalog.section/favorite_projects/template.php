            ...
            ?><div class="bx_catalog_item" id="<? echo $strMainID; ?>" > 
                <div class="bx_catalog_item_container min" > 
                    ...
                    <p class="info">
                        ...
                        <noindex>
                        <a href="/order/?nproj=<?=$arItem['CODE']?>" style="padding:3px 5px; text-decoration:none; background:#aaa; color:white;"><?=GetMessage("BUY")?></a><br>  
                        </noindex>                                                                                                                       
                    </p>           
                    <a href="javascipt::void()" data-project-id="<?=$arItem['ID']?>" class="remove_from_favorites"><?=GetMessage("REMOVE")?></a>      
                </div>
            </div><?
            }

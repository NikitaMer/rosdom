...
<h1>ћой профиль</h1>
¬ этом разделе ¬ы можете изменить свои контактные данные и пароль.
...
<table class="profile-table data-table">
	...
	?>
		...
		<tr>
			...
			<td><strong><?=$arResult["arUser"]["LOGIN"]?></strong></td>
	</tr>
	<?
	}
	?>
	...
	<tr>
		...
		<tr>
			...
			<td>+7&nbsp<input type="text" size="10" id="phone" name="PERSONAL_PHONE" maxlength="255" value="<?=$arResult["arUser"]["PERSONAL_PHONE"]?>" /></td>
		</tr>
	<tr>

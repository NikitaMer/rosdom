						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								case "A"://NUMBERS_WITH_SLIDER
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function(){
                                              $( "#wormPl" ).slider({                                              
                                                  ...
                                                  values : [20, 1600],//Значение, которое будет выставлено слайдеру при загрузке
                                    ...
                                    <div id="wormPl" class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"><div class="ui-slider-range ui-widget-header" style="left: 1.25%; width: 98.75%;"></div><a class="ui-slider-handle ui-state-default ui-corner-all" href="#" style="left: 1.25%;"></a><a class="ui-slider-handle ui-state-default ui-corner-all" href="#" style="left: 100%;"></a></div>
                                    От <span id="contentWormPlFrom"><?=number_format($arItem["VALUES"]["MIN"]["VALUE"], $precision, ".", "")?> - до
                                    <span id="contentWormPlTo"><?=number_format($arItem["VALUES"]["MAX"]["VALUE"], $precision, ".", "")?>
                                    <input type="hidden" id="plFrom" name="plFrom" value="20">
                                    <input type="hidden" id="plTo" name="plTo" value="1600">

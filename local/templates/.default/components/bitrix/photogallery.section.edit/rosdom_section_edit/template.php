...
<!-- 				<a rel="nofollow" href="<?=$arResult["SECTION"]["EDIT_ICON_LINK"]?>" onclick="BX.PreventDefault(event); EditAlbum('<?= addslashes(CUtil::JSEscape($arResult["SECTION"]["EDIT_ICON_LINK"]))?>'); return false;"><span><?=GetMessage("P_SECTION_EDIT_ICON")?></span></a> -->
				...
				<a rel="nofollow" href="<?=$icon_link?>" onclick="BX.PreventDefault(event); EditAlbum('<?=addslashes(CUtil::JSEscape($icon_link))?>'); return false;"><span><?=GetMessage("P_SECTION_EDIT_ICON")?></span></a>
...
$arFields = Array(
  ...
  "IBLOCK_ID" => $arResult["SECTION"]["ID"],
  "NAME" => $arResult["SECTION"]["ID"],
  "SORT" => $SORT,
//  "PICTURE" => $arPICTURE,
...
//LocalRedirect("/personal/my/photo/");

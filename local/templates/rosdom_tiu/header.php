...
<div id="grayBG" style="position:absolute; left:0; top:0; display:none; z-index:10;"></div>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DELAY" => "N",
		"ALLOW_MULTI_SELECT" => "N",
		"COMPONENT_TEMPLATE" => "rosdom_main_menu"
	),
	false,
	array(
		"ACTIVE_COMPONENT" => "Y"
...
false
 ...
 <?$APPLICATION->IncludeComponent("bitrix:main.include", "firms_top_submenu", Array(
	...
	false
      ...
      <aside>
<?$APPLICATION->IncludeComponent("bitrix:menu", "left_menu_tui", array(
	"ROOT_MENU_TYPE" => "left",
	"MENU_CACHE_TYPE" => "N",
	"MENU_CACHE_TIME" => "3600",
	"MENU_CACHE_USE_GROUPS" => "N",

...
<p>Проверьте, что Ваш ролик отображается корректно.</p>
<p>Если Вы не видите ролика, попробуйте обновить страницу кнопкой F5. </p>
<p>Если это не помогло, значит, Вы скопировали не тот код. </p>
<p>Пожалуйста, убедитесь, что код начинается и заканчивается либо тегами <?=htmlspecialcharsbx('"<iframe> ... </iframe>", либо "<object> ... </object>"')?></p>
<br /><br />
<div>
<?

<html>
	<head>
		<title><? if(host(0) != "catalog-domov")echo "Заказ проектов и консультации по телефонам: ".implode(", ",$phones); ?></title>
	...
	<body>
		<? 
			...
			if(host(0) != "catalog-domov"){
				...
				<b>Срок получения чертежей - от 1 до 5 дней.</b><br>
				...
				if(host(0) == "masterov")echo "Адрес офиса в Санкт-Петербурге: <b>Санкт-Петербург, Канал Грибоедова, д. 10, офис 16 (только по предварительной записи)</b><br>";
				echo "Каталог проектов <b>".host(0).".ru</b><br>
				E-mail: <b>".$info_email."</b></p>";
			}
		?>

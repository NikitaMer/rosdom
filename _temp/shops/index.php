...
$APPLICATION->SetTitle("Магазины стройматериалов, строительные рынки и ярмарки в Москве.");
?>
...
?>
<h1>Строительные магазины всех округов Москвы</h1>
<?
$db_list = CIBlockSection::GetList(Array("NAME"=>"ASC"), Array("IBLOCK_ID"=>"22"/*, "SECTION_ID"=>$section_id*/));
